...
require_once(dirname(__FILE__).'/include_pdf/tcpdf_font_data.php');
// TCPDF static font methods and data
require_once(dirname(__FILE__).'/include_pdf/tcpdf_fonts.php');
// TCPDF static color methods and data
require_once(dirname(__FILE__).'/include_pdf/tcpdf_colors.php');
// TCPDF static image methods and data
require_once(dirname(__FILE__).'/include_pdf/tcpdf_images.php');
// TCPDF static methods and data
require_once(dirname(__FILE__).'/include_pdf/tcpdf_static.php');
