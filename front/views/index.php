...
<body>
  ...
  <div class="carousel-inner">
      ...
      <div class="row">
         ...
         <h1 class="our_text">For<span style="color: #912f56;">um</span></h1>
            ...
            <div class="input_main">
              ...
              <table>
                    <tr>
            <td> <h2>id_poste |</h2></td>
            <td><h2>titre |</h2></td>
            <td><h2>contenu |</h2></td>
            
            <td><h2>date_de_pub |</h2></td>
            
            
            <td><h2>Supprimer | </h2></td>
            <td><h2>Details |</h2></td>
            <td><h2>ajouter commentaire | </h2></td>
            <td><h2>voir commentaire |</h2></td>
        ...
        ?>
            <tr>
                ...
                <td><a href="supprimer.php?id_poste=<?php echo $adh['id_poste']; ?>" class="button-1">Supprimer</a></td>
    
                <td>
                    <form method="POST"
                    action="detail.php">
    
                    <input type="submit" value="voir Details" class="button-1" >
                    <input type="hidden" name="id_poste" value="<?php echo $adh["id_poste"] ; ?>">
            </form>
           
            <td><a href="ajoutercommentaire.php?id_poste=<?php echo $adh['id_poste']; ?>" class="button-1">ajouter commentaire</a></td> 
            <td><a href="com.php?id_poste=<?php echo $adh['id_poste']; ?>" class="button-1">voir commentaire</a></td>
            </td>
    ...
    <a href="ajouter.php" class="button-1" >Ajouter poste
