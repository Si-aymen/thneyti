    ...
    <div class="carousel-item active">
      <div class="row">
        ...
        ?>
                ...
                <div class="book_bt"><a href="index12.html">play NOW</a></div>
                  </form>
                  </div>
                  </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <div class="book_bt"><a href="ajouter_moy.php">BOOK NOW</a></div>
          </div>
        </div>
      </div>
      <div class="container">
        <div class="row">
          <div class="col-sm-8">
            ...
            <div class="book_bt_2"><a href="ajouter_moy.php">BOOK NOW</a></div>
          </div>
          <div class="col-sm-4">
