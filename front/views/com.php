      ...
      <div class="row">
            ...
            <div class="content-2">
                <div class="recent-payments">
                    <div class="title">
                        ...
                        <a href="ajoutercommentaire.php" class="button-1" >Add commentaire
                    ...
                    <table>
                    <tr>
                    <td> <h1>id_poste |</h1></td>
            <td> <h1>id_commentaire |</h1></td>
            <td><h1>contenu |</h1></td>
            <td><h1>date_d'ajout |</h1></td>
        ...
        ?>
            ...
            <td><?php echo $adh['id_poste'];?></td>
                ...
                <td><a href="supprimerC.php?id_com=<?php echo $adh['id_com']; ?>" class="button-1">Supprimer</a></td>
