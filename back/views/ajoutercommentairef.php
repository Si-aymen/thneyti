            ...
            <div class="content-2">
                <div class="recent-payments">
                    <div class="title">
                        ...
                        <a href="comf.php" class="button-1" >retour au commentaires
...
<button    type="submit" class="button-1" name="submit" >Submit </button> 
...
echo "<script>alert('Vous avez ajouter un commentaire');</script>";
        echo "<script> window.location.href='comf.php'</script>";
}?> 
<script>
