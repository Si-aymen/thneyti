...
$s=0;  
if(
  isset($_POST['user'])&&isset($_POST['titre'])&&
isset($_POST['contenu'])&&  
isset($_POST['date_de_pub'])

)
{
    $poste=new poste($_POST['id_poste'],$_POST['user'],$_POST['titre'],$_POST['contenu'],$_POST['date_de_pub']);
 $s=1;
}
?>
<!DOCTYPE html>
            ...
            <div class="content-2">
                <div class="recent-payments">
                    <div class="title">
                        ...
                        <a href="forumf.php" class="button-1"> retour a la liste des postes</a>
...
<form action="" method="POST">
 <div><pre>
 <label for="user">user name: <input type="text"  id="user" name="user" >   
...
<button    type="submit" class="button-1" name="submit" Onclick="return validateForm()"  >Submit </button> 
        ...
        <?php if($s==1)
{
$posteC->ajouterb($poste);
echo "<script>alert('Vous avez ajouter un poste');</script>";
        echo "<script> window.location.href='forumf.php'</script>";
}?>  
<script>
