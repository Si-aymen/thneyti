...
<body>
    ...
    <form name="modifier poste"  method="POST" action="modifierp.php?id=<?PHP echo $row['id_poste']; ?>" >
          ...
          <button    type="submit" class="btn btn-primary" name="modifierp" Onclick="return validateForm()"  >modifier </button> 
...
if (isset($_POST['modifierp'])){
	...
	$posteC->modifierp($poste,$_POST['idcom_ini']);
